...
<main>
  ...
  <form method="POST" use:enhance>
    ...
    <FormGroup>
      <Input label="カウント" placeholder="例: 14" bind:value={count} borderColor={CCLVividColor.MELON_GREEN} />
    ...
    <FormGroup>
      <Input label="サイズ" placeholder="例: 50x70cm" bind:value={size} borderColor={CCLVividColor.MELON_GREEN} />
